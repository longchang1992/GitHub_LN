...
public class LinkedListDequeTest {
    ...
    public void getTest() {
        ...
        assertEquals(6, (int) lld.get(6));
        assertEquals(10, (int) lld.get(10));
        assertNull(lld.get(11));
        assertNull(lld.get(26));
    }
     @Test
    public void getRecursiveTest() {
        ...
        assertEquals(6, (int) lld.getRecursive(6));
        assertEquals(10, (int) lld.getRecursive(10));
        assertNull(lld.getRecursive(11));
        assertNull(lld.getRecursive(26));
    }
